...
from model.pelicula_dao import guardar, editar, Pelicula, eliminar, listar
...
def barra_menu(root):
    ...
    menu_inicio.add_command(
        label="Crea un Registro en DB", command=crear_tabla)
    menu_inicio.add_command(
...
class Frame(tk.Frame):
    ...
    def campo_pelicula(self):
        ...
        self.boton_nuevo = tk.Button(
            self, text="Nuevo", command=self.habilital_campos)
        ...
        self.boton_guardar.config(width=20, font=("Arial", 12, "bold"),
                                  fg="#DAD5D6", bg="#095362",
                                  cursor="hand2", activebackground="#79F1CD")
        ...
        self.boton_cancelar.config(width=20, font=("Arial", 12, "bold"),
                                   fg="#DAD5D6", bg="#F80404",
                                   cursor="hand2", activebackground="#FA7575")

        self.boton_cancelar.grid(row=3, column=2, padx=10, pady=10)

    def habilital_campos(self):
    ...
    def eliminar_datos(self):
        try:
            ...
            titulo = 'Eleiminar un registro'
            mensaje = 'No ha podido eliminar ningun registro'
            messagebox.showerror(titulo, mensaje)
